...
$(PARTIALDIR)/$(DISTNAME)/share: $(PARTIALDIR)/$(DISTNAME)
	@echo 'adding $(DISTNAME)/share'
	mkdir -m 0755 -p $(@D)
	@rm -rf $@ $@~
	@mkdir -m 0755 -p $@~
	@touch $@~
...
$(PARTIALDIR)/$(DISTNAME)/source/html: $(GARDIR)/../html/castorbox | $(PARTIALDIR)/$(DISTNAME)/source
...
$(PARTIALDIR)/$(DISTNAME)/source/gar-castorbox: $(abspath $(GARDIR)/..) | $(PARTIALDIR)/$(DISTNAME)/source
	@echo 'adding $(DISTNAME)/source/gar-castorbox'
	@mkdir -m 0755 -p $(@D)
	@rm -rf $@ $@~
	@rm -rf $@~~
	@mkdir -m 0755 -p $@~~
...
$(DOWNLOADDIR)/$(DISTNAME).tar.bz2: \
		...
		$(PARTIALDIR)/$(DISTNAME)/source \
		$(PARTIALDIR)/$(DISTNAME)/share \
		#$(PARTIALDIR)/$(DISTNAME)/source/lists/extras \
		#$(PARTIALDIR)/$(DISTNAME)/source/html \
		#$(PARTIALDIR)/$(DISTNAME)/source/gar-castorbox
